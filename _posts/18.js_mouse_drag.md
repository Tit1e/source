...
tags: 前端
---
鼠标拖拽是一种常见的js效果，下面贴一下原生js的实现方法。<br>
注：第一段段js代码来自网络，第二段是在第一段基础上改进实现的。由于时间太久找不到出处，侵删。<br>
先贴上一张对象和窗口之间距离的示意图方便理解，下文中也有注释。
<center><img src="https://cloud.githubusercontent.com/assets/17524418/22550750/7f157632-e98c-11e6-9d76-79e0ffb08e6c.gif"></center>
<!-- more -->
### HTML代码
``` html
<div id="move"></div>
